...
def normalize_lesson_plan_format(answer: str, request_message: str) -> str:
    ...
    disclaimer = "---\n*This content is generated by Nexa AI. Please review and adapt it to your classroom context, verify accuracy against your official curriculum, and use professional judgement before delivery.*"
