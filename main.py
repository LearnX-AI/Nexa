...
def normalize_lesson_plan_format(answer: str, request_message: str) -> str:
    ...
    # canonical disclaimer (exact final line expected)
    disclaimer = (
        "This response was generated by NEXA AI. Please verify important information with your official learning resources and consult your teacher or lecturer if needed. NEXA AI supports learning it does not replace your human teachers."
    )
...
async def read_url_endpoint(request: UrlReadRequest):
    ...
    if page_text.startswith("__ERROR__"):
        answer = append_generation_disclaimer(page_text.replace("__ERROR__", "").strip())
        return ChatResponse(
